	<footer id="main-footer">
		...
		<div id="footer-bottom">
			<div class="container clearfix">
				...
				<p class="disclaimer">Algonquin Bridge is a Division of AIL International Inc.</p>
				<div style="padding-top: 55px;">
					<?php echo et_get_footer_credits(); ?>
				<p class="footer-info" style="float: right;">&copy; <?php echo date('Y'); ?> Algonquin Bridge&nbsp;&nbsp;|&nbsp;&nbsp;</p>
				</div>
			</div>	<!-- .container -->
		</div>
	</footer> <!-- #main-footer -->
